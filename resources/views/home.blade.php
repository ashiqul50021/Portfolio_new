...
@section('content')
    ...
    <!-- Header Start -->
    <div class="container-fluid d-flex align-items-center mb-5 py-5" id="home" style="min-height: 100vh; background-image: url('/import/assets/images/bgimage.jpg');background-size: cover;background-position: center">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <h1 class="display-3 text-uppercase mb-2" style="-webkit-text-stroke: 2px #ffffff;">{{ $user?->name }}</h1>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    {{-- @dd(asset('storage/' . $setting->about_photo)) --}}
    ...
    <!-- Footer Start -->
    <div class="container-fluid text-white mt-5 py-5 px-sm-3 px-md-5" style="background-image: url('/import/assets/images/footer.jpg');background-size: cover;background-position: center">
        <div class="container text-center py-5">
            ...
            <p class="m-0">&copy; <a class="text-white font-weight-bold" href="https://ashiqulislamrasel.com/">Ashiqul Islam Rasel</a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
